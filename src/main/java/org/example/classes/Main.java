...
public class Main {
    public static void main(String[] args) {
        ...
        CustomerOrder customerOrder = new CustomerOrder(customer, "Television", 2);
        CustomerOrder customerOrder2 = new CustomerOrder(customer2, "Lettuce", 11);
        CustomerOrder customerOrder3 = new CustomerOrder(customer3, "Chocolate", 3);
